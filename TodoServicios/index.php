    ...
    <body id="style">
        ...
        <header id="nav_header">
            <div>
                ...
                <p>Los mejores servicios encuentralos al instante</p>
            </div>      
        </header>
        <!-- AQUI EMPIEZA EL HEADER-->
        ...
        <!-- AQUI EMPIEZA LA PANZA -->
         <nav>
            <table width="100%" border="1" bordercolor="#0000FF" cellspacing="10" cellpadding="10">
                <tr>
                    <td><a href="anunciaservicio.php">ANUNCIA SERVICIO</a></td>
                    <td><a href="encuentraservicio.php">ENCUENTRA SERVICIO</a></td>
                    <td><a href="contactanos.php">CONTACTANOS</a></td>
                </tr>
            </table>
        </nav>
